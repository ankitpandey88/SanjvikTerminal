...
//           <Link to="/environmental-policy" className={linkClasses}>Policy</Link>

//           {/* Media -> Redirect to /media-releases */}
//           <Link to="/media-releases" className={linkClasses}>Media</Link>
...
//                 { name: "Tariffs", link: "/traffic-overview" }, // Updated URL
//                 { name: "Policy", link: "/environmental-policy" }, // Updated URL
//                 { name: "Media", link: "/media-releases" }, // Updated URL
//                 { name: "Careers", link: "/careers" },
//                 { name: "Contact", link: "/contact-us" }, // Updated URL
//               ].map((item) => (
//                 <Link
//                   key={item.name}
//                   to={item.link}
...
function Header() {
  ...
  const handleMouseLeave = (setDropdownOpen) => {
    ...
    }, 100); // 200ms delay before closing the dropdown
          ...
          >
            ...
            {isServicesDropdownOpen && (
              <div
                ...
                onMouseLeave={() => handleMouseLeave(setServicesDropdownOpen)}
              >
                <Link to="/multi-model-transportation" className="block px-4 py-2 hover:bg-gray-200">
