...
//           <h2 className="text-4xl font-bold text-[#00308F] mb-4">Our Vision</h2>
...
//         />
//         <div className="transition-opacity duration-700 ease-in-out">
//           <h2 className="text-4xl font-bold text-[#00308F] mb-4">Our Mission</h2>
//           <p className="text-gray-700 leading-relaxed text-lg">
...
//       {/* Our Values Section */}
//       <div>
//         <h2 className="text-4xl font-bold text-[#00308F] mb-8 text-center">Our Values</h2>
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//           {/* Safety */}
//           <div className="flex items-start space-x-4 group">
//             <FaShieldAlt className="text-4xl text-[#00308F] transition-transform duration-300 transform group-hover:scale-125" />
//             <div className="transition-opacity duration-700 ease-in-out">
//               <h3 className="text-xl font-semibold text-[#00308F]">Safety</h3>
...
//           <div className="flex items-start space-x-4 group">
//             <FaUserTie className="text-4xl text-[#00308F] transition-transform duration-300 transform group-hover:scale-125" />
//             <div className="transition-opacity duration-700 ease-in-out">
//               <h3 className="text-xl font-semibold text-[#00308F]">Customer-Centric Approach</h3>
//               <p className="text-gray-600">
...
//           {/* Integrity */}
//           <div className="flex items-start space-x-4 group">
//             <FaCheckCircle className="text-4xl text-[#00308F] transition-transform duration-300 transform group-hover:scale-125" />
//             <div className="transition-opacity duration-700 ease-in-out">
//               <h3 className="text-xl font-semibold text-[#00308F]">Integrity</h3>
//               <p className="text-gray-600">
...
//           {/* Excellence */}
//           <div className="flex items-start space-x-4 group">
//             <FaGem className="text-4xl text-[#00308F] transition-transform duration-300 transform group-hover:scale-125" />
//             <div className="transition-opacity duration-700 ease-in-out">
//               <h3 className="text-xl font-semibold text-[#00308F]">Excellence</h3>
//               <p className="text-gray-600">
...
//           {/* Sustainability */}
//           <div className="flex items-start space-x-4 group">
//             <FaLeaf className="text-4xl text-[#00308F] transition-transform duration-300 transform group-hover:scale-125" />
//             <div className="transition-opacity duration-700 ease-in-out">
//               <h3 className="text-xl font-semibold text-[#00308F]">Sustainability</h3>
//               <p className="text-gray-600">
...
//           {/* Collaboration */}
//           <div className="flex items-start space-x-4 group">
//             <FaHandsHelping className="text-4xl text-[#00308F] transition-transform duration-300 transform group-hover:scale-125" />
//             <div className="transition-opacity duration-700 ease-in-out">
//               <h3 className="text-xl font-semibold text-[#00308F]">Collaboration</h3>
//               <p className="text-gray-600">
...
//         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
//           {/* Safety */}
//           <div className="flex items-start space-x-4 group transition-transform duration-300 transform hover:scale-105 hover:-rotate-1">
//             <FaShieldAlt className="text-4xl text-[#00308F] transition-transform duration-300 transform group-hover:scale-125" />
//             <div className="transition-opacity duration-700 ease-in-out">
