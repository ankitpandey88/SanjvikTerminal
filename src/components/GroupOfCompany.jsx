...
// const companies = [
//   { name: 'Company 1', logo: '/groupOfcompanys/Om infra.png' },
//   { name: 'Company 2', logo: '/groupOfcompanys/Om Logo-2.png' },
//   { name: 'Company 3', logo: '/groupOfcompanys/Om Trans.png' },
//   { name: 'Company 4', logo: '/groupOfcompanys/omxinfo logo.png' },
//   { name: 'Company 5', logo: '/groupOfcompanys/Telecom.jpg' },
//   { name: 'Company 6', logo: '/groupOfcompanys/TGL logo - file.png' },
//   { name: 'Company 7', logo: '/groupOfcompanys/Transafe.png' },
//   { name: 'Company 8', logo: '/groupOfcompanys/trax_logo_new.png' },
