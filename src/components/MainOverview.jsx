...
//     { icon: FaShieldAlt, title: 'Collaboration', description: 'Working together with partners, employees and stakeholders to nurture mutual growth and success.' }
//   ];
...
//             <h1 className="text-[#002D62] text-4xl md:text-5xl font-extrabold drop-shadow-lg mb-4 mt-8"> Our Vision</h1>
//           </div>
...
//         <div className="bg-indigo-100 py-8">
//           <div className="flex items-center justify-center text-center">
//             <h1 className="text-[#002D62] text-4xl md:text-5xl font-extrabold drop-shadow-lg mb-4 mt-8"> Our Mission</h1>
//           </div>
//           <div className="max-w-6xl mx-auto bg-alice-blue shadow-lg rounded-lg p-4">
//             <p className="mt-4 text-black leading-relaxed text-lg">
...
//                 }}
//                 className="bg-gradient-to-r from-white to-indigo-100 shadow-lg rounded-lg p-8 text-center transform hover:scale-105 hover:shadow-2xl transition duration-500 flex flex-col justify-center items-center"
//               >
//                 {/* Icon Centered */}
          ...
          >
            {values.map((value, index) => (
              <motion.div
                ...
                className={`bg-gradient-to-r from-white to-indigo-100 shadow-lg rounded-lg p-8 text-center transform hover:scale-105 hover:shadow-2xl transition duration-500 flex flex-col justify-center items-center ${index === values.length - 1 ? 'col-span-full' : ''}`} // Center the last item
              >
                {/* Icon Centered */}
                <value.icon className="text-indigo-600 text-6xl mb-4" />
                <h3 className="text-2xl font-bold text-indigo-700 mb-4">{value.title}</h3>
